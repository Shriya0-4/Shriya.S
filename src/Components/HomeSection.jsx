...
const HomeSection = ({ mousePosition, setActiveSection }) => (
  <section className="min-h-screen flex items-center justify-center relative z-10 overflow-hidden mt-10">
      ...
      <div className="space-y-12">
        <div className="relative space-y-6">
          <div className="relative overflow-hidden">
            <h1
              className="text-7xl lg:text-10xl leading-none tracking-widest relative z-10 bg-stone-800 via-orange-600 to-stone-800 bg-clip-text text-transparent font-black"
          ...
          <div className="relative">
            <h2 className="text-4xl lg:text-5xl font-light text-stone-600 tracking-[0.3em] uppercase">
              Web Developer
            </h2>
            <div className="absolute -bottom-5 left-1/2 transform -translate-x-1/2 space-y-1">
              <div className="w-48 h-0.5 bg-gradient-to-r from-orange-500 to-pink-500"></div>
              <div className="w-32 h-0.5 bg-gradient-to-r from-pink-500 to-orange-500 mx-auto"></div>
            </div>
          </div>
        </div>
        <div className="max-w-4xl mx-auto relative">
          <div className="absolute -top-6 left-0 text-6xl text-orange-200 opacity-30 font-serif">
            "
          </div>
          <div className="absolute -bottom-6 right-0 text-6xl text-orange-200 opacity-30 font-serif">
            "
          </div>

          <p className="text-2xl lg:text-3xl font-light text-stone-700 leading-relaxed px-8">
            Crafting Code{" "}
        ...
        <div className="flex items-center justify-center text-stone-500 bg-white/30 backdrop-blur-sm rounded-full px-8 py-4 border border-orange-100">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center pt-8">
          <button
            ...
            className="group relative bg-gradient-to-r from-orange-600 to-orange-700 text-white px-12 py-5 rounded-full font-medium hover:from-orange-700 hover:to-orange-800 transition-all duration-500 flex items-center space-x-3 shadow-2xl hover:shadow-orange-200/50 overflow-hidden"
          >
          ...
          <button
            ...
            className="group relative px-12 py-5 rounded-full font-medium border-2 border-stone-800 text-stone-800 hover:bg-stone-800 hover:text-white transition-all duration-300 tracking-wide overflow-hidden"
          >
